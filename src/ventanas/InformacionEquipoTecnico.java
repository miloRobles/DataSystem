...
public class InformacionEquipoTecnico extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InformacionEquipoTecnico frame = new InformacionEquipoTecnico();
	...
	public InformacionEquipoTecnico() {
		...
		idEquipos = GestionarEquipos.idEquipos;
		...
		textPane_ComentariosTecnico.setEditable(true);
		...
		JLabel lblNewLabel_1_9 = new JLabel("Comentarios del técnico:" + nombreUsuario);
		...
		JButton Btn_Actualizar = new JButton("Comentar y actualizar");
	...
	public void traerTodoEquipos() {
			...
			textPane_ComentariosTecnico.setText(equiposE.getComentarios());
	...
	public void actualizarEquipo() {
				...
				String comentarios = textPane_ComentariosTecnico.getText().toString();
				String revisionDe = this.nombreUsuario;
				
				Equipos equipos = new Equipos(idEquipos, estatus,comentarios,revisionDe);
		
				this.equiposControlador.actualizarEquiposTecnico(equipos);
